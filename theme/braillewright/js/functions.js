jQuery(document).ready(function($){
    ...
    function openPrimaryMenu() {
        ...
        if( menuPrimaryContainer.hasClass('open') ) {
            ...
            $(this).children('span').text(braillewright_objectL10n.openMenu);
            ...
            // change screen reader text
            $(this).children('span').text(braillewright_objectL10n.closeMenu);
    ...
    function openDropdownMenu() {
        ...
        if( window.innerWidth < 900 ) {
            ...
            if (menuItem.hasClass('open')) {
                ...
                // change screen reader text
                $(this).children('.screen-reader-text').text(braillewright_objectL10n.openChildMenu);
                ...
                // change screen reader text
                $(this).children('.screen-reader-text').text(braillewright_objectL10n.closeChildMenu);
